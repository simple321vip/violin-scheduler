  ...
  node(label) {
    def myRepo = checkout([
      ...
      userRemoteConfigs: [[
        ...
        url: 'https://gitee.com/guan-xiangwei/violin-scheduler.git'
        ]]
      ])
    ...
    def imageEndpoint = "violin/violin-scheduler"
      ...
      script{
        wrap([$class: 'BuildUser']) {
          withCredentials([usernamePassword(
            ...
            """
            sh "sed -i -e s/tagUpdateTime:.*/tagUpdateTime:' '${localDateTime}/g ./prod/violin-scheduler-deployment-prod.yaml"
            sh "sed -i -e s/violin-scheduler:.*/violin-scheduler:${imageTag}/g ./prod/violin-scheduler-deployment-prod.yaml"
            sh "git add ./prod/violin-scheduler-deployment-prod.yaml"
